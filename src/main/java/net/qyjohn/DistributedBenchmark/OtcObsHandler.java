...
public class OtcObsHandler implements ObjectStorageHandler
{
	public ObsClient client;

	public OtcObsHandler()
	{
		try
		{
			...
			prop.load(input);
			String obsEndpoint = prop.getProperty("otcObsEndpoint");
			String obsAccessKeyId = prop.getProperty("otcObsAccessKeyId");
			String obsSecretKeyId = prop.getProperty("otcObsSecretKeyId");
